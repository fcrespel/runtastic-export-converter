...
This project provides a command-line tool to convert Runtastic JSON exported data to standard TCX files.
...
To list sport sessions from an export directory (here, `runtastic-export-20190807-000` in the current directory):
    ...
    java -jar runtastic-export-converter-1.0.0-SNAPSHOT-jar-with-dependencies.jar list runtastic-export-20190807-000/Sport-sessions

To convert a sport session to TCX (here, session ID `fdd2f131-ef65-4e6c-b27e-50b8ecf465d4`):

    java -jar runtastic-export-converter-1.0.0-SNAPSHOT-jar-with-dependencies.jar convert runtastic-export-20190807-000/Sport-sessions fdd2f131-ef65-4e6c-b27e-50b8ecf465d4 fdd2f131-ef65-4e6c-b27e-50b8ecf465d4.tcx
